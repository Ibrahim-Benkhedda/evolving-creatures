...
class Simulation:
    """
    Simulation class represents a simulation environment for the creatures for evaluation
    """ 
    ...
    def update_motors(self, cid, cr):
        """
        updates the motors of the creature based on its joint configuration
    ...
    def eval_population(self, pop, iterations):
        """
        evaluates a population of creatures in the sim
        """
...
class ThreadedSim():
    """
    Manages multiple simulation instances for parallel processing
    """
    ...
    def static_run_creature(sim, cr, iterations):
        """
        runs a single creature in a given simulation
        """
